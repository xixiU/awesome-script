...
分类标准：
- blacklist：（最高优先级）包含上方"用户黑名单关键词"的评论（若已配置）；色情、约炮、线下见面等性暗示；诈骗、钓鱼、恶意链接；针对具体个人的直接死亡威胁或暴力恐吓（注意：情绪化的泛指脏话、抱怨社会、骂街发泄不算）；煽动针对特定族群的暴力或种族灭绝言论（注意：普通政治吐槽、讽刺体制、牢骚不算）；明显的机器人刷屏;大量 emoji/符号夹杂无实质内容的英文抒情句等；。
